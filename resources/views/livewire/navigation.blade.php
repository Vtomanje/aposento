<header class="bg-black shadow-lg sticky top-0 z-50" x-data="dropDown()">
    {{-- logo-categories-search-user-cart --}}
    <div class="containerNav flex items-center h-24 justify-between md:justify-start">        
        {{-- logo --}}
        ...
        class="flex flex-col items-center justify-center  order-last md:order-first px-6 md:px-4 text-black cursor-pointer ">
            ...
            <span class="text-sm text-white font-semibold hidden md:block">Categorías</span>
        </a>
        {{-- search --}}
            ...
            <ul class="bg-white">
                ...
                @foreach ($categories as $category)
                    <li class="navigation-link text-trueGray-500 hover:bg-fuchsia-500 hover:text-white">
                        ...
                        {{-- navigation-submenu --}}
                        <div class="navigation-submenu absolute w-3/4 h-full bg-gray-900 top-0 right-0 hidden">
                            {{-- subcategories hover --}}
